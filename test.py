...
bot = telebot.TeleBot('6102379005:AAGFDiLzOSiB5lIXsQPyxOgTCa0eie7Ue5A')

GROUP_ID = -1001814659079  # ID вашей группы
...
restricted_messages = ["кот", "i am vegan"]
...
def set_ro(message):
    ...
    bot.restrict_chat_member(message.chat.id, message.from_user.id, until_date=int(time())+600)
